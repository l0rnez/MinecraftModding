...
public class ChunkGeneratorLevitateTemplate implements IChunkGenerator
{
    ...
    protected static final IBlockState OTHER_BLOCK2 = Blocks.STONE.getDefaultState();
...
//    private final WorldGenStructure HOUSE = new WorldGenStructure("House");
    ...
    public ChunkGeneratorLevitateTemplate(World world, boolean generate, long seed)
    {
        this.world = world;
